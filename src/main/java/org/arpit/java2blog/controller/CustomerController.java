...
public class CustomerController {
	...
	/*RuleSet Revison*/
	@RequestMapping(value = "/ruleSetRevision/{id}", method = RequestMethod.GET)
	public String custRevision(@PathVariable("id") int id,Model model) {
		model.addAttribute("revCustomers", ruleService.getRuleSetUpRev(id));
		return "version";
	}
}
